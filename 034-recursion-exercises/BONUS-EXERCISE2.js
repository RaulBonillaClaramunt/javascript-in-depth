        ...
        childNodes: [
          {
            ...
            childNodes: [
              {
                nodeName: "script",
                innerText: "console.log('hi');",//BASE CASE
              },
            ],
          },
          {
...
//<div><h1>My blog</hi><p>Welcome to my blog!</p></div>
  const constructDOM = (node) => {
    let html = "";
    //check if object ia a base case / end of tree
    if (node.hasOwnProperty('innerText')) {
