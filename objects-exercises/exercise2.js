...
console.log('------------------------');
store.products[0].price = 1.75;//Change the price of the banana object through the store object to be 1.75.
console.log(store);//Print out both "store" and "banana"
console.log(store.products[0]);
console.log('------------------------');
candy.price = 4.99;//Change the price of the candy object directly to be 4.99
console.log(store);//Print out both "store" and "candy"
console.log(candy);
